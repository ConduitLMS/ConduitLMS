...
const auth0 = new Auth0Client({
  //REMOVE STRING IN FUTURE ITERATIONS
  domain: process.env.AUTH0_DOMAIN || 'conduitlms-dev.us.auth0.com',
  clientId: process.env.AUTH0_CLIENT_ID || 'cttYnKO9tcL4OcHGS83zGz0Hxi8kmZtG',
  authorizationParams: {
